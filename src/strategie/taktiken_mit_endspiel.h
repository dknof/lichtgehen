...
#ifndef TAKTIKEN_MIT_ENDSPIEL_H
#define TAKTIKEN_MIT_ENDSPIEL_H
 ...
 **/
class TaktikenMitEndspiel : public Taktiken {
  enum SpielStatus {
    NORMAL = 0,
...
#endif // #ifndef TAKTIKEN_MIT_ENDSPIEL_H
